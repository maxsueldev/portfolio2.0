...
if(isset($_POST['nome'])) {
	...
	$mail->From = "maxsuelf94@gmail.com";

	$mail->addAddress("maxsuelf94@gmail.com");
	...
	if(!$mail->send()) {
		...
		font-weight: normal;
		color: #fdc64b;
		\"><center><span>Aconteceu algum erro!</span><p>Você pode tentar novamente ou enviar direto para " . "maxsuelf94@gmail.com" . "!</p></center></h2>";
